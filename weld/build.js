...
export function build() {
  ...
  const buildHtml = (components) => {
    ...
    while (match === true) {
      ...
      Object.keys(components).forEach((component) => {
        var _a;
        const componentName =
          (_a = component.match(/\w+/i)) === null || _a === void 0
            ? void 0
            : _a[0];
  ...
  const sourceDir =
    (config === null || config === void 0 ? void 0 : config.input) ||
    Dir.Source;
  const destinationDir =
    (config === null || config === void 0 ? void 0 : config.output) ||
    Dir.Destination;
  const netlifyRedirects =
    ((_a = config === null || config === void 0 ? void 0 : config.netlify) ===
      null || _a === void 0
      ? void 0
      : _a._redirects) || false;
